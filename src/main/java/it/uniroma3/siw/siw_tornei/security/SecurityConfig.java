    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // 3. API REST e risorse statiche sono pubbliche
                .requestMatchers("/api/**", "/css/**", "/js/**", "/images/**").permitAll()

                // 4. TUTTO il resto (home, tornei, login, setup-admin, registrazione) è pubblico!
            ...
            .oauth2Login(oauth2 -> oauth2
                .loginPage("/login") // Usa la nostra stessa pagina custom
